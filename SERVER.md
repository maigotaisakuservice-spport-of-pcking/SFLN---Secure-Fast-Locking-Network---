...
- **DigitalOcean (推奨)**: 「Droplet」と呼ばれる VPS が非常に使いやすく、設定もシンプルです。Python 3.12+ の動作も公式にサポートされており、SFLN との相性が抜群です。
- **Oracle Cloud (Always Free)**: ARM 4コア / 24GB メモリ。クレジットカード登録が必要ですが、一生無料で使える強力な VPS 枠があります。
- **Google Cloud (Always Free)**: e2-micro インスタンス。性能は低いですが、リレー用として無料で運用可能です。
